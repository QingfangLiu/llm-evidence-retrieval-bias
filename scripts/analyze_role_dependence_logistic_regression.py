...
Writes `data/analysis/role_dependence_logistic_regression_results.json` (coefficients, odds
...
OUTPUT_PATH = ANALYSIS_DATA_DIR / "role_dependence_logistic_regression_results.json"
