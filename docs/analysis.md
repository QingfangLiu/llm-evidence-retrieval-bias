...
This page keeps the detailed reproduction commands, analysis notes, and output
interpretation for the retrieval-bias experiments. The root README is kept
concise for readers who only need the project overview.

## Regenerate review match tables
